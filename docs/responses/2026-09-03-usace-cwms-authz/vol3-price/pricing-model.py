...
COST = {"Joseph": 75, "Efrain": 100, "Scott": 60, "Zach": 75, "Randy": 65, "Andrew": 50, "Seth": 50}
CAT = {"Joseph": "PM", "Efrain": "SR", "Scott": "SR", "Zach": "SR", "Randy": "SR", "Andrew": "AS", "Seth": "AS"}
LABEL = {"Joseph": "Project Manager", "Efrain": "Senior Oracle DBA", "Scott": "System Engineer / Architect",
         "Zach": "Senior Forms (React/TypeScript) Developer", "Randy": "Senior Java Developer",
         "Andrew": "Associate Software Engineer", "Seth": "Associate Software Engineer"}
# CLIN, task, description, option?, hours by person
TASKS = [
    ("1001", "Task 1a", "Development meetings (26)", False, {"Joseph": 78, "Efrain": 8, "Scott": 12, "Zach": 12, "Randy": 12, "Seth": 8}),
    ("2001", "Task 2",  "Improve authorization web UI and CDA integration", False, {"Joseph": 50, "Efrain": 30, "Zach": 220, "Randy": 150, "Andrew": 100}),
    ("3001", "Task 3a", "Implement authorization in CWBI-Dev", False, {"Joseph": 40, "Scott": 120, "Randy": 40}),
    ("5001", "Task 5a", "Maintenance (≤803 h)", False, {"Joseph": 70, "Efrain": 60, "Zach": 100, "Randy": 150, "Seth": 400}),
    ("1002", "Task 1b", "Development meetings, additional 26 (option)", True, {"Joseph": 78, "Efrain": 8, "Scott": 12, "Zach": 12, "Randy": 12, "Seth": 8}),
    ("3002", "Task 3b", "Implement authorization in CWBI-Test (option)", True, {"Joseph": 20, "Scott": 80, "Randy": 20}),
    ("4001", "Task 4",  "Load testing (option)", True, {"Joseph": 20, "Efrain": 20, "Scott": 60, "Randy": 40, "Seth": 40}),
    ("5002", "Task 5b", "Maintenance (≤704 h) (option)", True, {"Joseph": 60, "Efrain": 50, "Zach": 90, "Randy": 130, "Seth": 350}),
]
