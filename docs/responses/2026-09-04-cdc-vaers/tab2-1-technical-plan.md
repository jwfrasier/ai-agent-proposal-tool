...
| 5 | **PRA implications for surveys/form changes** could stretch timelines outside the PoP | Flagged in our pre-quote questions; survey instruments delivered to clock regardless; schedule assumes CDC owns any required clearance in parallel [FLAG: confirm assumption wording after Bish Q&A response] |
